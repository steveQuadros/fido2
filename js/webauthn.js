...
function makeCredential() {
    ...
    var promise = new Promise((resolve, reject) => {
         resolve({
            "publicKey": {
              "challenge": "A9gjRdEXGh+FN+kJKjwMv7ySX04gtORVWf/Yntsxflg=",
              "timeout": 60000,
              rp: {
                name: "Demo server"
              },
              user: {
                id: 'abc123', // id may be generated by the server
              ...
              "allowCredentials": [
                {
                  "type": "public-key",
                  "id": "ALk91BO4l55XEdLqzNMG0BYn5O14lz8Yc8lh7Yeu3B66hxb6r/ZCfwD9rsUmoRmHnPuYWebMyr3VnWY="
                },
                {
                  "type": "public-key",
                  "id": "ALH2EXsnlA0UVN/JsDFvTxacBv8vpykmWMjiCqFkLmsM7v06ZNr4p0WpOKhuwuEgf+l2WT51pZQVDFA="
                },
                {
                  "type": "public-key",
                  "id": "rBw8hOm1kSxyIVqw415KdGCCwBFhPvM8LdqhgztYeSNkkXl5dO1/1Ngo1QVX5OM8QtAXGDjEOARWPI7ZC262bA=="
                },
                {
                  "type": "public-key",
                  "id": "W87tW5WZodpWEmqSojKD8FIIGegEmG8dtYFvVW8aodH48KaTj8jyUJXmQD45FkhtgMRHGDuJ1pSpClUKjm/HxQ=="
                }
              ],
              pubKeyCredParams: [
                {
    ...
    promise.then(function (makeCredentialOptions) {   
        console.log('Make credential options', makeCredentialOptions);         
...
function launchDialog(e, id) {
    console.log('launching dialog');
    var dialog = document.getElementById(id);
    if (dialog.classList.contains('ods-dialog--active')) {
        dialog.classList.remove('ods-dialog--active');  
    } else {
        dialog.classList.add('ods-dialog--active');
    }
};

function closeDialog(id) {
    var dialog = document.getElementById(id);
    document.getElementById('device-display-name').textContent = "";
    dialog.classList.remove('ods-dialog--active');
}
